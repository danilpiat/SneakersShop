...
SECRET_KEY = 'django-insecure-j7e_jh26*%4yg1w=_xv^ttoo*b#bpb-5q(6nk!kd5-geh@(#sf'
...
# Путь для сбора статических файлов при deploy
STATIC_ROOT = os.path.join(BASE_DIR, 'staticfiles')

# Дополнительные директории статических файлов
STATICFILES_DIRS = [
